    ...
    <div>
      <nav className="navbar navbar-light bg-light p-2">
        <div className="container-fluid">
          <a
            ...
            href="https://github.com/puneet-goel/JWT-Authentication"
          >
      ...
      <div className="container-fluid pt-3">
        <div className="row justify-content-center">
          <div
            className="card col-8 col-sm-6 bg-white px-3 pt-3"
            style={{ width: '18rem' }}
          >
            ...
            <div className="card-body p-3">
              ...
              <p className="card-text">
                I’m a MERN Stack Developer and a Competitive Programmer.
              </p>
              <a
                className="navbar-brand"
              ...
              <a
                ...
                href="mailto:puneetgoel016@gmail.com"
              >
